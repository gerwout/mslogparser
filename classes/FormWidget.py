...
class FormWidget(QWidget):
    ...
    def __controls(self):
        ...
        self.pids = QComboBox()
        self.pids.addItem("-")
        self.trans_ids = QComboBox()
        self.trans_ids.addItem("-")
    ...
    def __layout(self):
        ...
        self._grid.addWidget(self.pids)
        self._grid.addWidget(self.trans_ids)
    ...
    def handleSearch(self):
        ...
        pid = str(self.pids.currentText())
        trans_id = str(self.trans_ids.currentText())
